...
const AttachmentContain = ({ isAttachment }) => {
    ...
    const { data: attachmentsData, refetch, isLoading, fetchStatus } = useCustomQuery([attachment], () => request({ url: attachment, params: { search, sort: sorting, paginate: paginate, page } },router), {
