...
import { FullHomePageSettingTitle } from "@/data/TabTitleList";
...
const FullHomePageForm = ({ title,apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/full_page`, params: { slug: "full_page" } }), {
