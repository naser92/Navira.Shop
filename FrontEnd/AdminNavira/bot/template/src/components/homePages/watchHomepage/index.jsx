...
import { WatchHomePageSettingTitle } from "@/data/TabTitleList";
...
const WatchHomePageForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/watch`, params: { slug: "watch" } }), {
