...
import { ElectronicsTwoSettingTitle } from "@/data/TabTitleList";
...
const ElectronicsTwoForm = ({ title,apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/electronics_two`, params: { slug: "electronics_two" } }), {
