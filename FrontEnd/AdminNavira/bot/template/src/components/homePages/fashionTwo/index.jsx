...
import { FashionTwoSettingTitle } from "@/data/TabTitleList";
...
const FashionTwoForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/fashion_two`, params: { slug: "fashion_two" } }), {
