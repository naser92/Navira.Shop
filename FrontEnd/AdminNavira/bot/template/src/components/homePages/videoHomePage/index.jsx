...
import { VideoHomePageSettingTitle } from "@/data/TabTitleList";
...
const VideoHomePageForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/video`, params: { slug: "video" } }), {
