...
import BrandTab from "./jewelleryOneTabs/BrandTab";
import CategoriesTab from "./jewelleryOneTabs/CategoriesTab";
import CategoryProductTab from "./jewelleryOneTabs/CategoryProductTab";
import HomeBannerTab from "./jewelleryOneTabs/HomeBannerTab";
import ProductList1Tab from "./jewelleryOneTabs/ProductList1Tab";
import ServicesTab from "./jewelleryOneTabs/ServicesTab";
import SocialMediaTab from "./jewelleryOneTabs/SocialMediaTab";
import useCustomQuery from "@/utils/hooks/useCustomQuery";

const AllTabsJewelleryOne = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
...
export default AllTabsJewelleryOne;
