...
import { ElectronicsOneSettingTitle } from "@/data/TabTitleList";
...
const ElectronicsOneForm = ({ title,apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/electronics_one`, params: { slug: "electronics_one" } }), {
