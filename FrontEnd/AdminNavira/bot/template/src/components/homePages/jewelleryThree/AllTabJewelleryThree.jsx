...
import BrandTab from "./jewelleryThreeTabs/BrandTab";
import CategoriesTab from "./jewelleryThreeTabs/CategoriesTab";
import FeaturedBlogTab from "./jewelleryThreeTabs/FeaturedBlogTab ";
import HomeBannerTab from "./jewelleryThreeTabs/HomeBannerTab";
import MainBannerTab from "./jewelleryThreeTabs/MainBannerTab";
import OfferBanner1Tab from "./jewelleryThreeTabs/OfferBannerTab";
import ProductBannerTab from "./jewelleryThreeTabs/ProductBannerTab";
import ProductListTab from "./jewelleryThreeTabs/ProductListTab";
import ServicesTab from "./jewelleryThreeTabs/ServicesTab";
import SocialMediaTab from "./jewelleryThreeTabs/SocialMediaTab";
import useCustomQuery from "@/utils/hooks/useCustomQuery";

const AllTabsJewelleryThree = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
...
export default AllTabsJewelleryThree;
