...
import { JewelleryThreeOfferBannerTitle } from "@/data/TabTitleList";
...
const OfferBannerTab = ({ values, setFieldValue, productData, categoryData, setSearch }) => {
  ...
  return (
    <div className="inside-horizontal-tabs">
      <TabTitle activeTab={activeTab} setActiveTab={setActiveTab} titleList={JewelleryThreeOfferBannerTitle} />
