...
import { MarijuanaHomePageSettingTitle } from "@/data/TabTitleList";
...
const MarijuanaHomePageForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/marijuana`, params: { slug: "marijuana" } }), {
