...
import BannerTab from "./jewelleryTwoTabs/BannerTab";
import BrandTab from "./jewelleryTwoTabs/BrandTab";
import Categories2Tab from "./jewelleryTwoTabs/Categories2Tab";
import CategoriesTab from "./jewelleryTwoTabs/CategoriesTab";
import HomeBannerTab from "./jewelleryTwoTabs/HomeBannerTab";
import OfferBanner1Tab from "./jewelleryTwoTabs/OfferBanner1Tab";
import OfferBanner2Tab from "./jewelleryTwoTabs/OfferBanner2Tab";
import ProductBannerTab from "./jewelleryTwoTabs/ProductBannerTab";
import ProductList1Tab from "./jewelleryTwoTabs/ProductList1Tab";
import ProductList2Tab from "./jewelleryTwoTabs/ProductList2Tab";
import ServicesTab from "./jewelleryTwoTabs/ServicesTab";
import SocialMediaTab from "./jewelleryTwoTabs/SocialMediaTab";
import useCustomQuery from "@/utils/hooks/useCustomQuery";

const AllTabsJewelleryTwo = forwardRef(({ activeTab, values, setFieldValue, apiData = {} }, ref) => {
...
export default AllTabsJewelleryTwo;
