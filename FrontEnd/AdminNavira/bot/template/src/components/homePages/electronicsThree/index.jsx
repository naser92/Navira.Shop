...
import { ElectronicsThreeSettingTitle } from "@/data/TabTitleList";
...
const ElectronicsThreeForm = ({ title,apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/electronics_three`, params: { slug: "electronics_three" } }), {
