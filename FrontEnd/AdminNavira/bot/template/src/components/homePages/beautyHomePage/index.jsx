...
import { BeautyHomePageSettingTitle } from "@/data/TabTitleList";
...
const BeautyHomePageForm = ({ title, apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/beauty`, params: { slug: "beauty" } }), {
