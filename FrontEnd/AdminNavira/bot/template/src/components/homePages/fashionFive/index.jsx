...
import { FashionFiveSettingTitle } from "@/data/TabTitleList";
...
const FashionFiveForm = ({ title,apiData }) => {
  ...
  const { data, isLoading } = useCustomQuery([HomePageAPI], () => request({ url: `${HomePageAPI}/fashion_five`, params: { slug: "fashion_five" } }), {
