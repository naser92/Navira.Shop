...
{
    public class TaxRateQueryService : ITaxRateQueryService
    {

        #region variables

        private readonly ITaxRateQueryRepository _repository;

        #endregion

        #region constructors

        public TaxRateQueryService(ITaxRateQueryRepository taxrateRepository)
        {
            _repository = taxrateRepository;
        }
