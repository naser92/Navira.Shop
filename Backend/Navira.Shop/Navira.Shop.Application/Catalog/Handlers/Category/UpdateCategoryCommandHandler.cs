...
namespace Navira.Shop.Application.Handlers
{
    public class UpdateCategoryCommandHandler : CommandHandler, ICommandHandler<UpdateCategoryCommand>
    {
        ...
        public UpdateCategoryCommandHandler(IUnitOfWork uow) : base(uow)
        {


        }

        public Task<IResult> Handle(UpdateCategoryCommand command, CancellationToken cancellationToken = default)
        {
