...
namespace Navira.Shop.Application.Catalog
{
    public class ProductAttributeQueryService : IProductAttributeQueryService
    {
        ...
        private readonly IProductAttributeQueryRepository _repository;

        #endregion

        #region constructors

        public ProductAttributeQueryService(IProductAttributeQueryRepository productattributeRepository)
        {
