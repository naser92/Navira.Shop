...
{
    public class ProductAttributeOptionQueryService : IProductAttributeOptionQueryService
    {

        #region variables

        private readonly IProductAttributeOptionQueryRepository _repository;

        #endregion

        #region constructors

        public ProductAttributeOptionQueryService(IProductAttributeOptionQueryRepository productattributeoptionRepository)
        {
            _repository = productattributeoptionRepository;
        }
