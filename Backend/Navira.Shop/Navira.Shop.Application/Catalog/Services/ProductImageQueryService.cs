...
namespace Navira.Shop.Application.Catalog
{
    public class ProductImageQueryService : IProductImageQueryService
    {
        ...
        private readonly IProductImageQueryRepository _repository;

        #endregion

        #region constructors

        public ProductImageQueryService(IProductImageQueryRepository productimageRepository)
        {
            _repository = productimageRepository;
        }
