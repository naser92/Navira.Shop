...
namespace Navira.Shop.Core.Caching
{
    ...
    public partial class MemoryCacheManager : CacheKeyService, ILocker, IStaticCacheManager
    {
        ...
        private MemoryCacheEntryOptions PrepareEntryOptions(CacheKey key)
        {
            ...
            {
                AbsoluteExpirationRelativeToNow = key.CacheTime > 0 ? TimeSpan.FromMinutes(key.CacheTime) : null
            };
        ...
        public IEnumerable<RedisKey> GetKeys(string prefix, params object[] prefixParameters)
        {
