...
namespace Navira.Shop.Core.Caching
{
    ...
    public interface IStaticCacheManager : IDisposable
    {
        ...
        /// <summary>
        /// Get a all keys by perefix  from cache
        /// </summary>
        /// <param name="prefix">Keys prefix</param>
        /// <param name="prefixParameters">Keys prefix parameter </param>
        /// <returns>Enumerable of rediskeys </returns>
        IEnumerable<RedisKey> GetKeys(string prefix, params object[] prefixParameters);
        ...
        /// <summary>
        /// Remove the value with the specified key that concat defult config cache key prefix from the cache
        /// </summary>
        /// <param name="cacheKey">Cache key</param>
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        void RemoveWithDefaultPrefix(CacheKey cacheKey, params object[] cacheKeyParameters);
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        CacheKey PrepareKeyWithDefaultPrefix(CacheKey cacheKey, params object[] cacheKeyParameters);
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        CacheKey PrepareKeyWithDefaultPrefixForDefaultCache(CacheKey cacheKey, params object[] cacheKeyParameters);
        ...
        /// <param name="cacheKeyParameters">Parameters to create cache key</param>
        /// <returns>Cache key</returns>
        CacheKey PrepareKeyWithDefaultPrefixForShortTermCache(CacheKey cacheKey, params object[] cacheKeyParameters);
